...
Summary:        The DevMsgCtl library for REDHAWK
Name:           devmsgctlInterfaces
Version:        1.1.3
Release:        1%{?dist}
...
%description
Libraries and interface definitions for DevMsgCtl.
...
%{_datadir}/idl/redhawk/DEVMSGCTL
%{_includedir}/redhawk/DEVMSGCTL
%{_libdir}/libdevmsgctlInterfaces.*
%{_libdir}/pkgconfig/DevMsgCtlInterfaces.pc
%{_prefix}/lib/python/redhawk/devmsgctlInterfaces
%if 0%{?rhel} >= 6
%{_prefix}/lib/python/devmsgctlInterfaces-%{version}-py%{python_version}.egg-info
%endif
%if %{with java}
%{_prefix}/lib/DEVMSGCTLInterfaces.jar
%{_prefix}/lib/DEVMSGCTLInterfaces.src.jar
%endif

...
Summary:        The DevIOC library for REDHAWK
Name:           deviocInterfaces
Version:        1.1.1
Release:        1%{?dist}
...
%description
Libraries and interface definitions for DevIOC.
...
%{_datadir}/idl/redhawk/DEVIOC
%{_includedir}/redhawk/DEVIOC
%{_libdir}/libdeviocInterfaces.*
%{_libdir}/pkgconfig/DevIOCInterfaces.pc
%{_prefix}/lib/python/redhawk/deviocInterfaces
%if 0%{?rhel} >= 6
%{_prefix}/lib/python/deviocInterfaces-%{version}-py%{python_version}.egg-info
%endif
%if %{with java}
%{_prefix}/lib/DEVIOCInterfaces.jar
%{_prefix}/lib/DEVIOCInterfaces.src.jar
%endif

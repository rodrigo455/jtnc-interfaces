...
Summary:        The Audio library for REDHAWK
...
%description
Libraries and interface definitions for Audio.
...
%{_datadir}/idl/redhawk/AUDIO
%{_includedir}/redhawk/AUDIO
%{_libdir}/libaudioInterfaces.*
%{_libdir}/pkgconfig/AudioInterfaces.pc
%{_prefix}/lib/python/redhawk/audioInterfaces
%if 0%{?rhel} >= 6
%{_prefix}/lib/python/audioInterfaces-%{version}-py%{python_version}.egg-info
%endif
%if %{with java}
%{_prefix}/lib/AUDIOInterfaces.jar
%{_prefix}/lib/AUDIOInterfaces.src.jar
%endif

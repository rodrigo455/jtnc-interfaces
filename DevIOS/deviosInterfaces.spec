...
Summary:        The DevIOS library for REDHAWK
Name:           deviosInterfaces
Version:        1.1.1
Release:        1%{?dist}
...
%description
Libraries and interface definitions for DevIOS.
...
%{_datadir}/idl/redhawk/DEVIOS
%{_includedir}/redhawk/DEVIOS
%{_libdir}/libdeviosInterfaces.*
%{_libdir}/pkgconfig/DevIOSInterfaces.pc
%{_prefix}/lib/python/redhawk/deviosInterfaces
%if 0%{?rhel} >= 6
%{_prefix}/lib/python/deviosInterfaces-%{version}-py%{python_version}.egg-info
%endif
%if %{with java}
%{_prefix}/lib/DEVIOSInterfaces.jar
%{_prefix}/lib/DEVIOSInterfaces.src.jar
%endif

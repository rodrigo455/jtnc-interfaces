...
Summary:        The Vocoder library for REDHAWK
Name:           vocoderInterfaces
Version:         1.4
Release:        1%{?dist}
...
%description
Libraries and interface definitions for Vocoder.
...
%{_datadir}/idl/redhawk/VOCODER
%{_includedir}/redhawk/VOCODER
%{_libdir}/libvocoderInterfaces.*
%{_libdir}/pkgconfig/VocoderInterfaces.pc
%{_prefix}/lib/python/redhawk/vocoderInterfaces
%if 0%{?rhel} >= 6
%{_prefix}/lib/python/vocoderInterfaces-%{version}-py%{python_version}.egg-info
%endif
%if %{with java}
%{_prefix}/lib/VOCODERInterfaces.jar
%{_prefix}/lib/VOCODERInterfaces.src.jar
%endif

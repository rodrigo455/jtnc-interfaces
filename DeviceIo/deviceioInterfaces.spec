...
Summary:        The DeviceIo library for REDHAWK
Name:           deviceioInterfaces
Version:        1.0.2
Release:        1%{?dist}
...
%description
Libraries and interface definitions for DeviceIo.
...
%{_datadir}/idl/redhawk/DEVICEIO
%{_includedir}/redhawk/DEVICEIO
%{_libdir}/libdeviceioInterfaces.*
%{_libdir}/pkgconfig/DeviceIoInterfaces.pc
%{_prefix}/lib/python/redhawk/deviceioInterfaces
%if 0%{?rhel} >= 6
%{_prefix}/lib/python/deviceioInterfaces-%{version}-py%{python_version}.egg-info
%endif
%if %{with java}
%{_prefix}/lib/DEVICEIOInterfaces.jar
%{_prefix}/lib/DEVICEIOInterfaces.src.jar
%endif

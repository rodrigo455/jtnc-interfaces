...
Summary:        The Gps library for REDHAWK
Name:           gpsInterfaces
Version:        2.1.4
Release:        1%{?dist}
...
%description
Libraries and interface definitions for Gps.
...
%{_datadir}/idl/redhawk/GPS
%{_includedir}/redhawk/GPS
%{_libdir}/libgpsInterfaces.*
%{_libdir}/pkgconfig/GpsInterfaces.pc
%{_prefix}/lib/python/redhawk/gpsInterfaces
%if 0%{?rhel} >= 6
%{_prefix}/lib/python/gpsInterfaces-%{version}-py%{python_version}.egg-info
%endif
%if %{with java}
%{_prefix}/lib/GPSInterfaces.jar
%{_prefix}/lib/GPSInterfaces.src.jar
%endif
